...
use Magento\Cms\Helper\Data as HelperData;
...
use PluginCompany\ContactForms\Model\Entry\Collection as EntryCollection;
use PluginCompany\ContactForms\Model\Form as ModelForm;
...
class Form extends AbstractModel implements FormInterface
{
    ...
    public function getAllCssClasses()
    {
        ...
        $classes = array_merge($classes, explode(' ', $this->getCssClasses()));
        return $classes;
    }
    ...
    public function getConditionalAdminToEmail(DataObject $params){
        ...
        foreach($this->getConditToEmail() as $field){
            ...
            }elseif($field['match_type'] == 'contains' && stristr($params[$fieldName],$field['value'])){
                $conditionalMatches[] = $field['email'];
            }
        }
