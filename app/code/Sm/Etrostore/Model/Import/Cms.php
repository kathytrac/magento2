...
namespace Sm\Etrostore\Model\Import;
...
class Cms
{
    ...
    public function __construct(
        ...
        $this->_importPath = BP . '/app/code/Sm/Etrostore/etc/import/';
    ...
    public function importCms($type)
    {
        ...
        try {
            ...
            if($this->_scopeConfig->getValue("etrostore/theme_install/overwrite_".$type)) {
                $overwrite = true;
            }
